...
void TextShader::SetMat4(const std::string& name, glm::mat4 matrix) const
{
	glUniformMatrix4fv(glGetUniformLocation(ID, name.c_str()), 1, GL_FALSE, glm::value_ptr(matrix));
}

void TextShader::SetVec3(const std::string& name, glm::vec3 vector) const
{
...
{
	textColor_Location = glGetUniformLocation(ID, "textColor");
	projection_Location = glGetUniformLocation(ID, "projectionMatrix");
}
